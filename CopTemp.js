 function createPlayerCop(that) {
     ...
     that.weapon = that.game.add.weapon(30, "bullet")
     that.weapon.bulletKillType = Phaser.Weapon.KILL_WORLD_BOUNDS;
     that.weapon.bulletSpeed = 750;
     that.weapon.fireRate = 770;
     that.weapon.bullets.forEach((b) => {
     ...
     that.playerCop.walkingSound.set("volume", 0.2);
     ...
     that.playerCop.animations.add('shoot', Phaser.Animation.generateFrameNames('Shoot_', 0, 14, '', 3), 20.2, true);
